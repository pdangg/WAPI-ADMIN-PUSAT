...
@section('content')
    <div class="flex flex-col flex-1 p-6">
        ...
        <header class="flex items-center justify-between bg-white p-6 rounded shadow mb-6">
            <h1 class="text-2xl font-bold">New User / Trial</h1>
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="border-b-2 p-2">Nama User</th>
                        <th class="border-b-2 p-2">Email</th>
                        <th class="border-b-2 p-2">Register Data</th>
                        <th class="border-b-2 p-2">Trial</th>
                        <th class="border-b-2 p-2">Credit Expired</th>
                ...
                <tbody>
                    <tr class="bg-gray-100">
                        ...
                        <td class="border-b p-2 text-center">Pak Joko</td>
                        <td class="border-b p-2 text-center">joko@email.com</td>
                        <td class="border-b p-2 text-center">31 Mei 2024</td>
                        <td class="border-b p-2 text-center">13 Juni 2024</td>
                        <td class="border-b p-2 text-center">-</td>
                    ...
                    <tr>
                        ...
                        <td class="border-b p-2 text-center">Harjo</td>
                        <td class="border-b p-2 text-center">harjo@email.com</td>
                        <td class="border-b p-2 text-center">31 Mei 2024</td>
                        <td class="border-b p-2 text-center">13 Juni 2024</td>
                        <td class="border-b p-2 text-center">14 Juli 2024</td>
                        <td class="border-b p-2 text-center">
                    ...
                    <tr>
                        ...
                        <td class="border-b p-2 text-center">Agus</td>
                        <td class="border-b p-2 text-center">aggguuus@email.com</td>
                        <td class="border-b p-2 text-center">31 September 2024</td>
                        <td class="border-b p-2 text-center">13 Oktober 2024</td>
                    ...
                    <tr>
                        ...
                        <td class="border-b p-2 text-center">Budi</td>
                        <td class="border-b p-2 text-center">budiii@email.com</td>
                        <td class="border-b p-2 text-center">31 Januari 2024</td>
                        <td class="border-b p-2 text-center">13 Maret 2024</td>
                    ...
                    <tr>
                        ...
                        <td class="border-b p-2 text-center">Heri</td>
                        <td class="border-b p-2 text-center">Herrrri@email.com</td>
                        <td class="border-b p-2 text-center">31 April 2024</td>
                ...
                <div class="flex justify-center items-center">
                    <div>
                        <nav class="inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                            <a href="#" class="px-2 py-1 text-sm bg-white border border-gray-300 text-gray-500">1</a>
                            <a href="#"
                                class="px-2 py-1 text-sm bg-gray-200 border border-gray-300 text-gray-500">2</a>
                            <a href="#" class="px-2 py-1 text-sm bg-white border border-gray-300 text-gray-500">3</a>
                            <a href="#"
                                class="px-2 py-1 text-sm bg-white border border-gray-300 text-gray-500">...</a>
                            <a href="#" class="px-2 py-1 text-sm bg-white border border-gray-300 text-gray-500">20</a>
                        </nav>
                    </div>
                </div>
            </div>
