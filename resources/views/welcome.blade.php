...
<head>
    ...
    <style>
        .active {
            background-color: #333f54; /* bg-green-700 */
        }
    </style>
</head>
    ...
    <div class="flex">
        <aside class="w-64 bg-gray-900 text-white p-4">
            ...
            <nav class="flex flex-col space-y-4">
                <a href="{{ route('index') }}" class="py-2.5 px-6 bg-gray-900 hover:bg-gray-800 flex items-center">
                ...
                <a href="{{ route('newuser') }}" class="py-2.5 px-6 bg-gray-900 hover:bg-gray-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('welcome') }}" class="py-2.5 px-6 bg-gray-900 hover:bg-gray-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('userorder') }}" class="py-2.5 px-6 bg-gray-900 hover:bg-gray-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('pricelist') }}" class="py-2.5 px-6 bg-gray-900 hover:bg-gray-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" />
                    </svg>                    
                    Pricelist
                </a>
                <a href="{{ route('usertemplate') }}" class="py-2.5 px-6 bg-gray-900 hover:bg-gray-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
